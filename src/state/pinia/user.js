...
export const useUserStore = defineStore("user", {
    ...
    actions: {
        ...
        async getUsers() {
            try {
                const url = `${this.apiUrl}/v1/users?page=${this.current}&perPage=${this.perpage}&name=${this.searchQuery}&id=${this.searchQuery}`;
        ...
        async getUser(id) {
            try {
                const res = await axios.get(`${this.apiUrl}/v1/users/${id}`);
